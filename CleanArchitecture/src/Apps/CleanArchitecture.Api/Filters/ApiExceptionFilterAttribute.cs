...
namespace CleanArchitecture.Api.Filters
{
    ...
    public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
    {
        ...
        {
            string methodInfo = $"Controller : {context.ActionDescriptor.DisplayName}, ";
            var details = ServiceResult.Failed(new ServiceError("An exception occured.", 999, methodInfo + context.Exception.Message));
