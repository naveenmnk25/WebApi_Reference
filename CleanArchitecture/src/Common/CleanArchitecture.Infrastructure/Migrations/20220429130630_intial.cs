    ...
    public partial class intial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DefaultSettingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DefaultSetting", x => x.DefaultSettingId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StaticDataTypeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Active = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaticDataType", x => x.StaticDataTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StaticDataId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StaticDataTypeId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaticData", x => x.StaticDataId);
                    table.ForeignKey(
                        name: "FK_StaticData_StaticDataType_StaticDataTypeId",
                        column: x => x.StaticDataTypeId,
                        principalTable: "StaticDataType",
                        principalColumn: "StaticDataTypeId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttributeData_StaticData_TypeId",
                        column: x => x.TypeId,
                        principalTable: "StaticData",
                        principalColumn: "StaticDataId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Developer_Developer_ManagerId",
                        column: x => x.ManagerId,
                        principalTable: "Developer",
                        principalColumn: "DeveloperId");
                    table.ForeignKey(
                        name: "FK_Developer_StaticData_DesignationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkItem_StaticData_PriorityId",
                        column: x => x.PriorityId,
                        principalTable: "StaticData",
                        principalColumn: "StaticDataId");
                    table.ForeignKey(
                        name: "FK_WorkItem_StaticData_SeverityId",
                        column: x => x.SeverityId,
                        principalTable: "StaticData",
                        principalColumn: "StaticDataId");
                    table.ForeignKey(
                        name: "FK_WorkItem_StaticData_StatusId",
                        column: x => x.StatusId,
                        principalTable: "StaticData",
                        principalColumn: "StaticDataId");
                    table.ForeignKey(
                        name: "FK_WorkItem_StaticData_WorkItemTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttributeData_TypeId",
                table: "AttributeData",
                column: "TypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Developer_DesignationId",
                table: "Developer",
                column: "DesignationId");

            migrationBuilder.CreateIndex(
                name: "IX_Developer_ManagerId",
                table: "Developer",
                column: "ManagerId");
